...
export declare const getLocalTrackStats: (getStats: HMSWebrtcStats['getStats'], track: HMSLocalTrack, peerName?: string, prevTrackStats?: Record<string, HMSTrackStats>) => Promise<Record<string, HMSTrackStats> | undefined>;
export declare const getTrackStats: (getStats: HMSWebrtcStats['getStats'], track: HMSRemoteTrack, peerName?: string, prevTrackStats?: HMSTrackStats) => Promise<HMSTrackStats | undefined>;
