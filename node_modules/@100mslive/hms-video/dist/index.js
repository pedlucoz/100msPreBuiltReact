var er=Object.defineProperty,tr=Object.defineProperties;var ir=Object.getOwnPropertyDescriptors;var Be=Object.getOwnPropertySymbols;var oi=Object.prototype.hasOwnProperty,ci=Object.prototype.propertyIsEnumerable;var di=(a,e,t)=>e in a?er(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t,v=(a,e)=>{for(var t in e||(e={}))oi.call(e,t)&&di(a,t,e[t]);if(Be)for(var t of Be(e))ci.call(e,t)&&di(a,t,e[t]);return a},L=(a,e)=>tr(a,ir(e));var kt=(a,e)=>{var t={};for(var i in a)oi.call(a,i)&&e.indexOf(i)<0&&(t[i]=a[i]);if(a!=null&&Be)for(var i of Be(a))e.indexOf(i)<0&&ci.call(a,i)&&(t[i]=a[i]);return t};var rr=(a,e)=>()=>(e||a((e={exports:{}}).exports,e),e.exports);var c=(a,e,t)=>new Promise((i,r)=>{var s=l=>{try{d(t.next(l))}catch(h){r(h)}},n=l=>{try{d(t.throw(l))}catch(h){r(h)}},d=l=>l.done?i(l.value):Promise.resolve(l.value).then(s,n);d((t=t.apply(a,e)).next())});var Si=rr((ms,lr)=>{lr.exports={name:"@100mslive/hms-video",version:"0.7.4",license:"MIT",main:"dist/index.cjs.js",typings:"dist/index.d.ts",module:"dist/index.js",files:["dist","src"],engines:{node:">=10"},exports:{".":{require:"./dist/index.cjs.js",import:"./dist/index.js",default:"./dist/index.js"}},scripts:{prestart:"rm -rf dist && yarn types:build",start:'concurrently "yarn dev" "yarn types"',dev:"node ../../scripts/dev","build:only":"node ../../scripts/build",build:"yarn build:only && yarn types:build",types:"tsc -w","types:build":"tsc -p tsconfig.json",test:"jest --maxWorkers=1",lint:"eslint -c ../../.eslintrc .","lint:fix":"yarn lint --fix",prepare:"yarn build",size:"size-limit",analyze:"size-limit --why",format:"prettier --write src/**/*.ts"},author:"100ms <tech-common@100ms.live>",devDependencies:{"@types/sdp-transform":"^2.4.4","@types/ua-parser-js":"^0.7.36","@types/uuid":"^8.3.0","jest-canvas-mock":"^2.3.1",tslib:"^2.2.0"},dependencies:{eventemitter2:"^6.4.7","sdp-transform":"^2.14.1","ua-parser-js":"^1.0.1",uuid:"^8.3.2","webrtc-adapter":"^8.0.0"},gitHead:"36f8d865f05deffecd7a64fb7f3aba1070561584"}});import Xi from"webrtc-adapter";import{UAParser as sr}from"ua-parser-js";import{v4 as ar}from"uuid";var te=class{constructor(e){this.key=e;this.storage=null}getStorage(){return X&&!this.storage&&(li(),this.storage=window.localStorage),this.storage}get(){var i;let e=(i=this.getStorage())==null?void 0:i.getItem(this.key);return e?JSON.parse(e):void 0}set(e){var i;let t=JSON.stringify(e);(i=this.getStorage())==null||i.setItem(this.key,t)}clear(){var e;(e=this.getStorage())==null||e.removeItem(this.key)}};var pe=new sr,mi,me=typeof window=="undefined"&&!((mi=pe.getBrowser().name)==null?void 0:mi.toLowerCase().includes("electron")),X=typeof window!="undefined",W;(function(i){i.PROD="prod",i.QA="qa",i.DEV="dev"})(W||(W={}));var nr=()=>!me,$r=nr(),ui=()=>pe.getDevice().type==="mobile",hi=()=>{let a,e=new te("hms-analytics-deviceId"),t=e.get();return t?a=t:(a=ar(),e.set(a)),a},pi=()=>typeof document!="undefined"&&document.hidden,yt=()=>{var a;return((a=pe.getOS().name)==null?void 0:a.toLowerCase())==="ios"};var gi=class{constructor(){this.valuesMap=new Map}getItem(e){return this.valuesMap.has(e)?String(this.valuesMap.get(e)):null}setItem(e,t){this.valuesMap.set(e,t)}removeItem(e){this.valuesMap.delete(e)}clear(){this.valuesMap.clear()}key(e){if(arguments.length===0)throw new TypeError("Failed to execute 'key' on 'Storage': 1 argument required, but only 0 present.");return Array.from(this.valuesMap.keys())[e]}get length(){return this.valuesMap.size}},li=()=>{X&&!localStorage&&(window.localStorage=new gi)};var U;(function(l){l[l.VERBOSE=0]="VERBOSE",l[l.DEBUG=1]="DEBUG",l[l.INFO=2]="INFO",l[l.WARN=3]="WARN",l[l.TIME=4]="TIME",l[l.TIMEEND=5]="TIMEEND",l[l.ERROR=6]="ERROR",l[l.NONE=7]="NONE"})(U||(U={}));var or=typeof window!="undefined"&&typeof window.expect!="undefined",o=class{static v(e,...t){this.log(0,e,...t)}static d(e,...t){this.log(1,e,...t)}static i(e,...t){this.log(2,e,...t)}static w(e,...t){this.log(3,e,...t)}static e(e,...t){this.log(6,e,...t)}static time(e){this.log(4,"[HMSPerformanceTiming]",e)}static timeEnd(e){this.log(5,"[HMSPerformanceTiming]",e,e)}static cleanUp(){performance.clearMarks(),performance.clearMeasures()}static log(e,t,...i){if(!(this.level.valueOf()>e.valueOf()))switch(e){case 0:{console.log(t,...i);break}case 1:{console.debug(t,...i);break}case 2:{console.info(t,...i);break}case 3:{console.warn(t,...i);break}case 6:{console.error(t,...i);break}case 4:{performance.mark(i[0]);break}case 5:{let r=i[0];try{let s=performance.measure(r,r);this.log(1,t,r,s==null?void 0:s.duration),performance.clearMarks(r),performance.clearMeasures(r)}catch(s){this.log(1,t,r,s)}break}}}};o.level=or?7:0;var Ee=class{constructor({sender:e,message:t,type:i="chat",recipientPeer:r,recipientRoles:s,time:n}){this.sender=e,this.message=t,this.type=i,this.recipientPeer=r,this.recipientRoles=s,this.time=n}toSignalParams(){var r,s;let e=(r=this.recipientRoles)==null?void 0:r.map(n=>n.name),t=(s=this.recipientPeer)==null?void 0:s.peerId,i={info:{message:this.message,type:this.type}};return(e==null?void 0:e.length)&&(i.roles=e),t&&(i.peer_id=t),i}toString(){var e;return`{
      sender: ${this.sender};
      ...
      time: ${this.time};
      type: ${this.type};
    }`}};var Ge=class{constructor(e,t){this.id=e;this.store=t;this.recording={server:{running:!1},browser:{running:!1},hls:{running:!1}};this.rtmp={running:!1};this.hls={running:!1,variants:[]}}get localPeer(){return this.store.getLocalPeer()}get peers(){return this.store.getPeers()}};var oe=class{constructor({peerId:e,name:t,isLocal:i,customerUserId:r,metadata:s,role:n,joinedAt:d}){this.customerUserId="";this.metadata="";this.auxiliaryTracks=[];this.name=t,this.peerId=e,this.isLocal=i,this.customerUserId=r,this.metadata=s,this.joinedAt=d,n&&(this.role=n)}updateRole(e){this.role=e}updateName(e){this.name=e}updateMetadata(e){this.metadata=e}toString(){var e,t,i;return`{
      name: ${this.name};
    ...
    }`}};import{v4 as cr}from"uuid";var He=class{};He.makePeerId=()=>cr();var Ve=class extends oe{constructor(e){super(L(v({},e),{peerId:He.makePeerId(),isLocal:!0}));this.isLocal=!0;this.auxiliaryTracks=[];this.asRole=e.asRole}isInPreview(){return!!this.asRole}toString(){var e,t,i;return`{
      name: ${this.name};
      role: ${(e=this.role)==null?void 0:e.name};
      peerId: ${this.peerId};
      customerUserId: ${this.customerUserId};
      ...
      ${this.audioTrack?`audioTrack: ${(t=this.audioTrack)==null?void 0:t.trackId};`:""}
      ${this.videoTrack?`videoTrack: ${(i=this.videoTrack)==null?void 0:i.trackId};`:""}
    }`}};var $e=class extends oe{constructor(e){super(L(v({},e),{isLocal:!1}));this.isLocal=!1;this.auxiliaryTracks=[];this.fromRoomState=!1;this.fromRoomState=!!e.fromRoomState}};import{v4 as kr}from"uuid";import{v4 as ur}from"uuid";var ie;(function(i){i.CUSTOM="CUSTOM",i.LOCAL="LOCAL",i.HMS="HMS"})(ie||(ie={}));function dr(){if(X&&window){let a=window.location.hostname;return a==="localhost"||a==="127.0.0.1"?ie.LOCAL:a.includes("app.100ms.live")?ie.HMS:ie.CUSTOM}return ie.CUSTOM}var ke=dr();var vi=Si().version;function Le(a=W.PROD,e){let t="web",i=ke!==ie.LOCAL&&a===W.PROD?"prod":"debug";if(me)return Ti({os:"web_nodejs",os_version:process.version,sdk:t,sdk_version:vi,env:i,domain:ke,framework:"node",framework_version:process.version,framework_sdk_version:e==null?void 0:e.sdkVersion});let r=pe.getOS(),s=pe.getDevice(),n=pe.getBrowser(),d=Mt(`web_${r.name}`),l=r.version||"",h=Mt(`${n.name}_${n.version}`),u=h;return s.type&&(u=`${Mt(`${s.vendor}_${s.type}`)}/${h}`),Ti({os:d,os_version:l,sdk:t,sdk_version:vi,device_model:u,env:i,domain:ke,framework:e==null?void 0:e.type,framework_version:e==null?void 0:e.version,framework_sdk_version:e==null?void 0:e.sdkVersion})}function Mt(a){return a.replace(/ /g,"_")}var Ti=(a,e=",")=>Object.keys(a).filter(t=>!!a[t]).map(t=>`${t}:${a[t]}`).join(e);var x=class{constructor({name:e,level:t,properties:i,includesPII:r,timestamp:s}){this.metadata={peer:{},userAgent:Le()};this.name=e,this.level=t,this.includesPII=r||!1,this.properties=i||{},this.timestamp=s||new Date().getTime(),this.event_id=ur(),this.device_id=hi()}toSignalParams(){return{name:this.name,info:L(v({},this.properties),{timestamp:this.timestamp,domain:ke}),timestamp:new Date().getTime()}}};var We;(function(r){r[r.VERBOSE=0]="VERBOSE",r[r.INFO=1]="INFO",r[r.ERROR=2]="ERROR",r[r.OFF=3]="OFF"})(We||(We={}));var _;(function(r){r[r.VERBOSE=0]="VERBOSE",r[r.INFO=1]="INFO",r[r.ERROR=2]="ERROR",r[r.OFF=3]="OFF"})(_||(_={}));var T=class extends Error{constructor(e,t,i,r,s,n=!1){super(r);this.code=e;this.name=t;this.message=r;this.description=s;this.isTerminal=n;Object.setPrototypeOf(this,T.prototype),this.action=i.toString()}toAnalyticsProperties(){return{error_name:this.name,error_code:this.code,error_message:this.message,error_description:this.description,action:this.action,is_terminal:this.isTerminal}}addNativeError(e){this.nativeError=e}toString(){var e;return`{
      code: ${this.code};
      name: ${this.name};
      action: ${this.action};
      message: ${this.message};
