...
export declare const Checkbox: {
    Root: import("@stitches/react/types/styled-component").StyledComponent<import("react").ForwardRefExoticComponent<CheckboxPrimitive.CheckboxProps & import("react").RefAttributes<HTMLButtonElement>>, {}, {
        allowMotion: string;
        sm: string;
        md: string;
        lg: string;
    ...
    Indicator: import("@stitches/react/types/styled-component").StyledComponent<import("react").ForwardRefExoticComponent<CheckboxPrimitive.CheckboxIndicatorProps & import("react").RefAttributes<HTMLSpanElement>>, {}, {
        allowMotion: string;
        sm: string;
        md: string;
        lg: string;
